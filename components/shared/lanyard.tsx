...
const CARD_GLB = '/images/card.glb';
const LANYARD_PNG = '/images/lanyard.png';

extend({ MeshLineGeometry, MeshLineMaterial });

declare module '@react-three/fiber' {
  interface ThreeElements {
    meshLineGeometry: React.ComponentProps<'mesh'> & { attach?: string };
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 flex h-full w-full origin-center scale-100 items-center justify-end">
...
function Band({
  ...
  // Three.js texture wrap must be set directly on the object — this is not a state mutation.
